...
contract MasterChef is Ownable {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        console.log(pool.accCakePerShare,"accCakePerShare");
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        ...
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
        console.log(user.rewardDebt,"withdraw user rewardDebt");
        ...
        user.rewardDebt = user.amount.mul(pool.accCakePerShare).div(1e12);
        console.log(pool.accCakePerShare,"withdraw accPerShare");
    ...
    function enterStaking(uint256 _amount) public {
        ...
        if (_amount > 0) {
            // console.log("pool lp", address(pool.lpToken));
            pool.lpToken.safeTransferFrom(
                address(msg.sender),
                address(this),
                _amount
    ...
    function leaveStaking(uint256 _amount) public {
        ...
        require(user.amount >= _amount, "withdraw: not good");
        updatePool(0);
        console.log("reqard debt",user.rewardDebt,pool.accCakePerShare);
        uint256 pending = user.amount.mul(pool.accCakePerShare).div(1e12).sub(
            user.rewardDebt
        );
        if (pending > 0) {
